...
var test = function(x,y,a,cx,v,next){
...
var com = function(bx,by,ba,cx,CP,RG,next,v){
  ...
  var a = test(bx,by,ba,cx,next);
  
  return[bx,by,ba,a[2],v];  
};
...
$(document).ready(function(){
  si = setInterval(function(){vars = com(vars[0],vars[1],vars[2],cx,v[0],v[1],vars[3],vars[4]);},10);
